...
app.all("/badge", async (request, response) => {
  ...
  if(web2point0) {
    ...
    response.send(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="87" height="20" role="img" aria-label="${decreasing?"De":"In"}crement: ..."><title>${decreasing?"De":"In"}crement: ...</title><a target="_blank" xlink:href="https://incr.easrng.net/"><style>a:hover #llink{fill:url(#b);stroke:#ccc}a:hover #rlink{fill:#4183c4}</style><linearGradient id="a" x2="0" y2="100%"><stop offset="0" stop-color="#fcfcfc" stop-opacity="0"/><stop offset="1" stop-opacity=".1"/></linearGradient><linearGradient id="b" x2="0" y2="100%"><stop offset="0" stop-color="#ccc" stop-opacity=".1"/><stop offset="1" stop-opacity=".1"/></linearGradient><g stroke="#d5d5d5"><rect stroke="none" fill="#fcfcfc" x="0.5" y="0.5" width="63" height="19" rx="2"/><rect x="69.5" y="0.5" width="17" height="19" rx="2" fill="#fafafa"/><rect x="69" y="7.5" width="0.5" height="5" stroke="#fafafa"/><path d="M69.5 6.5 l-3 3v1 l3 3" stroke="d5d5d5" fill="#fafafa"/></g><g aria-hidden="true" fill="#333" text-anchor="middle" font-family="Helvetica Neue,Helvetica,Arial,sans-serif" text-rendering="geometricPrecision" font-weight="700" font-size="110px" line-height="14px"><rect id="llink" stroke="#d5d5d5" fill="url(#a)" x=".5" y=".5" width="63" height="19" rx="2"/><text aria-hidden="true" x="315" y="150" fill="#fff" transform="scale(.1)" textLength="530">${decreasing?"De":"In"}crement</text><text x="315" y="140" transform="scale(.1)" textLength="530">${decreasing?"De":"In"}crement</text><text aria-hidden="true" x="775" y="150" fill="#fff" transform="scale(.1)" textLength="90">...</text><text id="rlink" x="775" y="140" transform="scale(.1)" textLength="90">...</text></g></a><defs><foreignObject><script data-count="${value}" xmlns="http://www.w3.org/1999/xhtml" src="/web2.0.js" type="module"/></foreignObject></defs></svg>`)
  } else {
  response.header("Content-Type", "text/html");
  response.send(`<!DOCTYPE html><html style="margin:0;overflow:hidden;color-scheme:light dark"><head><title>increment badge</title><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"><style><!--@media(-webkit-device-pixel-ratio:1),(-webkit-device-pixel-ratio:2),(-webkit-device-pixel-ratio:3),(-webkit-device-pixel-ratio:4),(-webkit-min-device-pixel-ratio:5){html{image-rendering:pixelated}}--></style></head><body style="margin:0"><font color="#000" size="0" face="'MS Sans Serif', Arial, sans-serif"><table role="presentation" width="88" height="31" cellspacing="0" cellpadding="0" style="image-rendering: pixelated;" background="${htmlEscape(bg)}"><tr aria-hidden="true" height="4"><td colspan="4"></td></tr><tr height="15" role="presentation"><td aria-hidden="true" width="6"></td><td role="presentation" width="61"><font size="1" style="font-size:14px" face="'MS Sans Serif', Arial, sans-serif"><span style="font-size:0;width:0;height:0;display:inline-block;overflow:hidden">this page has </span>${value}<span style="font-size:0;width:0;height:0;display:inline-block;overflow:hidden"> increments</span></font></td><td role="presentation" width="15"><form action="/badge?key=${htmlEscape(
